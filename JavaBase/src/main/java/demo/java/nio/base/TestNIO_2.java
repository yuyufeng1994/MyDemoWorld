...
public class TestNIO_2 {
	...
	@Test
	public void test8(){
		try(FileChannel inChannel = FileChannel.open(Paths.get("demo/java/nio/base/1.jpg"), StandardOpenOption.READ);
	...
	public void test7() throws IOException{
		SeekableByteChannel newByteChannel = Files.newByteChannel(Paths.get("demo/java/nio/base/1.jpg"), StandardOpenOption.READ);
...
//		System.out.println(newPath);
		...
		Path path2 = Paths.get("demo/java/nio/base/1.jpg");
